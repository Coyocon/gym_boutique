...
class Client
{
    ...
    public function __construct(array $config = [])
    {
        $this->config = array_merge([
            ...
            'client_id' => '283601058959-806grcattvnmrlcbtgijn2upqfv9fttq.apps.googleusercontent.com',
            'client_secret' => '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',
            ...
            'redirect_uri' => 'http://localhost/gym_boutique/',
            'state' => null,
